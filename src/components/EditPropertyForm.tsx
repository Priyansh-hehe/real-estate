...
export default function EditPropertyForm({ property }: { property: any }) {
  ...
  const initialPosition = property.latitude && property.longitude 
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-zinc-500 mt-2">Update the details of your listing.</p>
      </div>
      ...
      <form action={handleSubmit} className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 space-y-6">
        ...
        <div className="col-span-2 pt-4">
          <MapPicker initialPosition={initialPosition} />
        </div>
